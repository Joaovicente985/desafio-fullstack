...
exports.deleteUserController = exports.updateUserController = exports.createUserController = exports.readUserController = void 0;
...
const readUser_service_1 = require("../services/users/readUser.service");
...
const readUserController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userInfo = yield (0, readUser_service_1.readUserService)(userId);
...
const updateUserController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userId = res.locals.userId;
    const updatedUser = yield (0, updateUser_service_1.updateUserService)(userId, newUserData);
